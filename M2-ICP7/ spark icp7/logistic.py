...
import os
os.environ["SPARK_HOME"] = "/Users/anushakonakalla/Downloads/spark-2.4.3-bin-hadoop2.7"
...
data = spark.read.format("csv").option("header", True).option("inferSchema", True).option("delimiter", ",").load("/Users/anushakonakalla/Desktop/Automobile_data.csv")
